...
public class CircleProgressView extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mProgressTextSize =a.getDimension(R.styleable.CircleProgressView_progress_text_size, 16);
    ...
    private void init() {
        ...
        mPaintText.setTextSize(sp2px(mProgressTextSize));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mRectF.set(w/20*2,w/20*2, mWidth - w/20*2, mHeight - w/20*2);
    }
